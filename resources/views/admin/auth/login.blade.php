...
<head>
    <!-- Title -->
    <title>Pemetaan Gempa - Login</title>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('admin/logo/logo-sekolah.jpg') }}">
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <div class="text-center mb-3">
                                        <a href="/"><img class="img-fluid" src="{{ asset('admin/images/logo-full.png') }}" alt=""></a>
                                    </div>
